<?php 
	...
	writeStartTag("Item");
            ...
            writeElement("Code", $product->getItemNumber());
            writeElement("SKU", $product->getItemNumber());
            writeElement("Name", $product->getWebSku());
			...
			{
				writeStartTag("Attribute");
				writeElement("Name", "Size");
				writeelement("Value", $product->getAttributeText('size'));
			    writeCloseTag("Attribute");
			}
			if ($product->getColorCode()||$product->getAttributeText('color_code'))
			{
                if ($product->getAttributeText('size')){
				writeStartTag("Attribute");
				writeElement("Name", "ColorCode");
				writeelement("Value", $product->getAttributeText('color_code'));
			    writeCloseTag("Attribute");
            }
            else {
                writeStartTag("Attribute");
                writeElement("Name", "ColorCode");
                writeelement("Value", $product->getColorCode());
                writeCloseTag("Attribute");
            }
			}
            if ($product->getAlu()||$product->getAttributeText('alu'))
            {
                if ($product->getAttributeText('alu')){
                writeStartTag("Attribute");
                writeElement("Name", "Alu");
                writeelement("Value", $product->getAttributeText('alu'));
                writeCloseTag("Attribute");
            }
            else
            {
                writeStartTag("Attribute");
                writeElement("Name", "Alu");
                writeelement("Value", $product->getAlu());
                writeCloseTag("Attribute");
             }
             }
			...
			{
				writeStartTag("Attribute");
				writeElement("Name", "Length");
				writeelement("Value", $product->getAttributeText('length'));
			    writeCloseTag("Attribute");
			}
