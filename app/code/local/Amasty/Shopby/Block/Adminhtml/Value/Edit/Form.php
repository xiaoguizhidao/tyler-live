...
class Amasty_Shopby_Block_Adminhtml_Value_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function prepareFieldsetMain()
    {
        ...
        $note = new Varien_Data_Form_Element_Note(array(
            'text' => $this->__('You need to enable option <b>Show on List</b> on filter edit page in order to make these settings work. You also need to perform modifications in theme template, see Amasty Improved Navigation User Guide on page 16.'),
        ));
    ...
    protected function prepareFieldsetProductView()
    {
        ...
        $note = new Varien_Data_Form_Element_Note(array(
            'text' => $this->__('You need to enable option <b>Show on Product</b> on filter edit page in order to make these settings work. You also need to perform modifications in theme template, see Amasty Improved Navigation User Guide on page 15.'),
        ));
